...
/// <summary>
/// Verifies EnterpriseOidcCallback (IDN-16) against contracts/api-contract.yaml's
/// GET /auth/sso/enterprise/{idpAlias}/oidc/callback path.
/// </summary>
public class EnterpriseOidcCallbackContractTests : IClassFixture<IdentityApiFactory>
{
    private const string ContractPath = "/auth/sso/enterprise/{idpAlias}/oidc/callback";
    private readonly IdentityApiFactory _factory;

    public EnterpriseOidcCallbackContractTests(IdentityApiFactory factory) => _factory = factory;
    ...
    public void Contract_DefinesCallbackPathWith200And401()
    {
        ...
        Assert.Equal("enterpriseOidcCallback", getOp["operationId"]);
    ...
    public async Task LiveEndpoint_ValidCode_MatchesDocumentedTokenPairShape()
    {
        ...
        var response = await client.GetAsync($"/v1/auth/sso/enterprise/{IdentityApiFactory.TestOidcIdpAlias}/oidc/callback?code={code}&state=opaque-state");
    ...
    public async Task LiveEndpoint_InvalidCode_Returns401()
    {
        ...
        var response = await client.GetAsync($"/v1/auth/sso/enterprise/{IdentityApiFactory.TestOidcIdpAlias}/oidc/callback?code=invalid-code&state=opaque-state");
