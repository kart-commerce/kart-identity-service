...
/// <summary>
/// Verifies UnlockUser (IDN-11) against contracts/api-contract.yaml's POST
/// /internal/users/{userId}/unlock path.
/// </summary>
public class UnlockUserContractTests : IClassFixture<IdentityApiFactory>
{
    private const string ContractPath = "/internal/users/{userId}/unlock";
    ...
    public UnlockUserContractTests(IdentityApiFactory factory) => _factory = factory;

    [Fact]
    public void Contract_DefinesUnlockPathWithClientCredentialsSecurity()
    {
        ...
        Assert.Equal("unlockUser", postOp["operationId"]);
    ...
    public async Task LiveEndpoint_AdminScopedCaller_Returns204()
    {
        ...
        var email = $"unlock-contract-{Guid.NewGuid():N}@example.com";
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, $"/v1/internal/users/{user.UserId}/unlock");
